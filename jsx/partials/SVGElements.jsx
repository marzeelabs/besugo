  ...
  S10.3,12.6,7.4,12.6z"></path>
    ...
    L12.8,10.4z M30.8,10.4c2.2,1.5,3.2,3.8,3.2,6.3c0,4.7-3.4,8-8.1,8c-4.3,0-8-2.8-8-8c0-2.4,0.9-4.5,2.1-6.4L27.2,0h8L30.8,10.4z"></path>
          ...
          <symbol id="facebook-icon" viewBox="0 0 30 30">
            <path d="M15,0C6.7,0,0,6.7,0,15s6.7,15,15,15s15-6.7,15-15S23.3,0,15,0z M18.6,10.4h-2.3c-0.3,0-0.6,0.4-0.6,0.8v1.6      h2.8l-0.4,2.3h-2.4v7h-2.7v-7h-2.4v-2.3h2.4v-1.4c0-2,1.4-3.6,3.2-3.6h2.3V10.4z"></path>
          </symbol>
    ...
    c0.1,0,0.2,0,0.3,0C13.4,13.3,13.9,12,13.6,10.8z"/>
          ...
          <symbol id="time-icon" viewBox="0 0 20 20">
            <path d="M10,0C4.5,0,0,4.5,0,10s4.5,10,10,10c5.5,0,10-4.5,10-10S15.5,0,10,0z M10,18c-4.4,0-8-3.6-8-8s3.6-8,8-8 s8,3.6,8,8S14.4,18,10,18z M10.5,10.2l4.5,2.7l-0.8,1.2L9,11V5h1.5V10.2z"></path>
          </symbol>

          <symbol id="role-icon" viewBox="0 0 20 20">
            <path d="M18,4.5h-4V2.7c0-1.2-1-2.2-2.2-2.2H8.2C7,0.5,6,1.5,6,2.7v1.8H2c-1.1,0-2,0.9-2,2v2v2v7c0,1.1,0.9,2,2,2h16  c1.1,0,2-0.9,2-2v-7v-2v-2C20,5.4,19.1,4.5,18,4.5z M8,2.7c0-0.1,0.1-0.2,0.2-0.2h3.6c0.1,0,0.2,0.1,0.2,0.2v1.8H8V2.7z M18,17.5H2 v-7h16V17.5z M2,8.5v-2h4h8h4v2H2z"></path>
          </symbol>

          <symbol id="origin-icon" viewBox="0 0 20 20">
            <path d="M10,0C6.1,0,3,3.1,3,7c0,5.2,7,13,7,13s7-7.8,7-13C17,3.1,13.9,0,10,0z M10,9.5C8.6,9.5,7.5,8.4,7.5,7  S8.6,4.5,10,4.5s2.5,1.1,2.5,2.5S11.4,9.5,10,9.5z"></path>
          </symbol>
