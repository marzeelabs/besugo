...
1. [hugo](https://gohugo.io/) v0.42.1 - builds the structure of the website based on the content setup, although we're phasing it out in favor of a fully JS/React solution. Any version over 0.27.1 should still work though.
...
2. [yarn](https://yarnpkg.com/) v1.7.0 - package/dependency manager. Any version of yarn above 0.27.5 should still work though.
